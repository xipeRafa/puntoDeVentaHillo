...
*/var gs,LR;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(I,_){function S(){}S.prototype=_.prototype,I.D=_.prototype,I.prototype=new S,I.prototype.constructor=I,I.C=function(R,C,x){for(var A=Array(arguments.length-2),pt=2;pt<arguments.length;pt++)A[pt-2]=arguments[pt];return _.prototype[C].apply(R,A)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(I,_,S){S||(S=0);var R=Array(16);if(typeof _=="string")for(var C=0;16>C;++C)R[C]=_.charCodeAt(S++)|_.charCodeAt(S++)<<8|_.charCodeAt(S++)<<16|_.charCodeAt(S++)<<24;else for(C=0;16>C;++C)R[C]=_[S++]|_[S++]<<8|_[S++]<<16|_[S++]<<24;_=I.g[0],S=I.g[1],C=I.g[2];var x=I.g[3],A=_+(x^S&(C^x))+R[0]+3614090360&4294967295;_=S+(A<<7&4294967295|A>>>25),A=x+(C^_&(S^C))+R[1]+3905402710&4294967295,x=_+(A<<12&4294967295|A>>>20),A=C+(S^x&(_^S))+R[2]+606105819&4294967295,C=x+(A<<17&4294967295|A>>>15),A=S+(_^C&(x^_))+R[3]+3250441966&4294967295,S=C+(A<<22&4294967295|A>>>10),A=_+(x^S&(C^x))+R[4]+4118548399&4294967295,_=S+(A<<7&4294967295|A>>>25),A=x+(C^_&(S^C))+R[5]+1200080426&4294967295,x=_+(A<<12&4294967295|A>>>20),A=C+(S^x&(_^S))+R[6]+2821735955&4294967295,C=x+(A<<17&4294967295|A>>>15),A=S+(_^C&(x^_))+R[7]+4249261313&4294967295,S=C+(A<<22&4294967295|A>>>10),A=_+(x^S&(C^x))+R[8]+1770035416&4294967295,_=S+(A<<7&4294967295|A>>>25),A=x+(C^_&(S^C))+R[9]+2336552879&4294967295,x=_+(A<<12&4294967295|A>>>20),A=C+(S^x&(_^S))+R[10]+4294925233&4294967295,C=x+(A<<17&4294967295|A>>>15),A=S+(_^C&(x^_))+R[11]+2304563134&4294967295,S=C+(A<<22&4294967295|A>>>10),A=_+(x^S&(C^x))+R[12]+1804603682&4294967295,_=S+(A<<7&4294967295|A>>>25),A=x+(C^_&(S^C))+R[13]+4254626195&4294967295,x=_+(A<<12&4294967295|A>>>20),A=C+(S^x&(_^S))+R[14]+2792965006&4294967295,C=x+(A<<17&4294967295|A>>>15),A=S+(_^C&(x^_))+R[15]+1236535329&4294967295,S=C+(A<<22&4294967295|A>>>10),A=_+(C^x&(S^C))+R[1]+4129170786&4294967295,_=S+(A<<5&4294967295|A>>>27),A=x+(S^C&(_^S))+R[6]+3225465664&4294967295,x=_+(A<<9&4294967295|A>>>23),A=C+(_^S&(x^_))+R[11]+643717713&4294967295,C=x+(A<<14&4294967295|A>>>18),A=S+(x^_&(C^x))+R[0]+3921069994&4294967295,S=C+(A<<20&4294967295|A>>>12),A=_+(C^x&(S^C))+R[5]+3593408605&4294967295,_=S+(A<<5&4294967295|A>>>27),A=x+(S^C&(_^S))+R[10]+38016083&4294967295,x=_+(A<<9&4294967295|A>>>23),A=C+(_^S&(x^_))+R[15]+3634488961&4294967295,C=x+(A<<14&4294967295|A>>>18),A=S+(x^_&(C^x))+R[4]+3889429448&4294967295,S=C+(A<<20&4294967295|A>>>12),A=_+(C^x&(S^C))+R[9]+568446438&4294967295,_=S+(A<<5&4294967295|A>>>27),A=x+(S^C&(_^S))+R[14]+3275163606&4294967295,x=_+(A<<9&4294967295|A>>>23),A=C+(_^S&(x^_))+R[3]+4107603335&4294967295,C=x+(A<<14&4294967295|A>>>18),A=S+(x^_&(C^x))+R[8]+1163531501&4294967295,S=C+(A<<20&4294967295|A>>>12),A=_+(C^x&(S^C))+R[13]+2850285829&4294967295,_=S+(A<<5&4294967295|A>>>27),A=x+(S^C&(_^S))+R[2]+4243563512&4294967295,x=_+(A<<9&4294967295|A>>>23),A=C+(_^S&(x^_))+R[7]+1735328473&4294967295,C=x+(A<<14&4294967295|A>>>18),A=S+(x^_&(C^x))+R[12]+2368359562&4294967295,S=C+(A<<20&4294967295|A>>>12),A=_+(S^C^x)+R[5]+4294588738&4294967295,_=S+(A<<4&4294967295|A>>>28),A=x+(_^S^C)+R[8]+2272392833&4294967295,x=_+(A<<11&4294967295|A>>>21),A=C+(x^_^S)+R[11]+1839030562&4294967295,C=x+(A<<16&4294967295|A>>>16),A=S+(C^x^_)+R[14]+4259657740&4294967295,S=C+(A<<23&4294967295|A>>>9),A=_+(S^C^x)+R[1]+2763975236&4294967295,_=S+(A<<4&4294967295|A>>>28),A=x+(_^S^C)+R[4]+1272893353&4294967295,x=_+(A<<11&4294967295|A>>>21),A=C+(x^_^S)+R[7]+4139469664&4294967295,C=x+(A<<16&4294967295|A>>>16),A=S+(C^x^_)+R[10]+3200236656&4294967295,S=C+(A<<23&4294967295|A>>>9),A=_+(S^C^x)+R[13]+681279174&4294967295,_=S+(A<<4&4294967295|A>>>28),A=x+(_^S^C)+R[0]+3936430074&4294967295,x=_+(A<<11&4294967295|A>>>21),A=C+(x^_^S)+R[3]+3572445317&4294967295,C=x+(A<<16&4294967295|A>>>16),A=S+(C^x^_)+R[6]+76029189&4294967295,S=C+(A<<23&4294967295|A>>>9),A=_+(S^C^x)+R[9]+3654602809&4294967295,_=S+(A<<4&4294967295|A>>>28),A=x+(_^S^C)+R[12]+3873151461&4294967295,x=_+(A<<11&4294967295|A>>>21),A=C+(x^_^S)+R[15]+530742520&4294967295,C=x+(A<<16&4294967295|A>>>16),A=S+(C^x^_)+R[2]+3299628645&4294967295,S=C+(A<<23&4294967295|A>>>9),A=_+(C^(S|~x))+R[0]+4096336452&4294967295,_=S+(A<<6&4294967295|A>>>26),A=x+(S^(_|~C))+R[7]+1126891415&4294967295,x=_+(A<<10&4294967295|A>>>22),A=C+(_^(x|~S))+R[14]+2878612391&4294967295,C=x+(A<<15&4294967295|A>>>17),A=S+(x^(C|~_))+R[5]+4237533241&4294967295,S=C+(A<<21&4294967295|A>>>11),A=_+(C^(S|~x))+R[12]+1700485571&4294967295,_=S+(A<<6&4294967295|A>>>26),A=x+(S^(_|~C))+R[3]+2399980690&4294967295,x=_+(A<<10&4294967295|A>>>22),A=C+(_^(x|~S))+R[10]+4293915773&4294967295,C=x+(A<<15&4294967295|A>>>17),A=S+(x^(C|~_))+R[1]+2240044497&4294967295,S=C+(A<<21&4294967295|A>>>11),A=_+(C^(S|~x))+R[8]+1873313359&4294967295,_=S+(A<<6&4294967295|A>>>26),A=x+(S^(_|~C))+R[15]+4264355552&4294967295,x=_+(A<<10&4294967295|A>>>22),A=C+(_^(x|~S))+R[6]+2734768916&4294967295,C=x+(A<<15&4294967295|A>>>17),A=S+(x^(C|~_))+R[13]+1309151649&4294967295,S=C+(A<<21&4294967295|A>>>11),A=_+(C^(S|~x))+R[4]+4149444226&4294967295,_=S+(A<<6&4294967295|A>>>26),A=x+(S^(_|~C))+R[11]+3174756917&4294967295,x=_+(A<<10&4294967295|A>>>22),A=C+(_^(x|~S))+R[2]+718787259&4294967295,C=x+(A<<15&4294967295|A>>>17),A=S+(x^(C|~_))+R[9]+3951481745&4294967295,I.g[0]=I.g[0]+_&4294967295,I.g[1]=I.g[1]+(C+(A<<21&4294967295|A>>>11))&4294967295,I.g[2]=I.g[2]+C&4294967295,I.g[3]=I.g[3]+x&4294967295}r.prototype.u=function(I,_){_===void 0&&(_=I.length);for(var S=_-this.blockSize,R=this.B,C=this.h,x=0;x<_;){if(C==0)for(;x<=S;)i(this,I,x),x+=this.blockSize;if(typeof I=="string"){for(;x<_;)if(R[C++]=I.charCodeAt(x++),C==this.blockSize){i(this,R),C=0;break}}else for(;x<_;)if(R[C++]=I[x++],C==this.blockSize){i(this,R),C=0;break}}this.h=C,this.o+=_},r.prototype.v=function(){var I=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);I[0]=128;for(var _=1;_<I.length-8;++_)I[_]=0;var S=8*this.o;for(_=I.length-8;_<I.length;++_)I[_]=S&255,S/=256;for(this.u(I),I=Array(16),_=S=0;4>_;++_)for(var R=0;32>R;R+=8)I[S++]=this.g[_]>>>R&255;return I};function s(I,_){var S=a;return Object.prototype.hasOwnProperty.call(S,I)?S[I]:S[I]=_(I)}function o(I,_){this.h=_;for(var S=[],R=!0,C=I.length-1;0<=C;C--){var x=I[C]|0;R&&x==_||(S[C]=x,R=!1)}this.g=S}var a={};function l(I){return-128<=I&&128>I?s(I,function(_){return new o([_|0],0>_?-1:0)}):new o([I|0],0>I?-1:0)}function c(I){if(isNaN(I)||!isFinite(I))return f;if(0>I)return k(c(-I));for(var _=[],S=1,R=0;I>=S;R++)_[R]=I/S|0,S*=4294967296;return new o(_,0)}function h(I,_){if(I.length==0)throw Error("number format error: empty string");if(_=_||10,2>_||36<_)throw Error("radix out of range: "+_);if(I.charAt(0)=="-")return k(h(I.substring(1),_));if(0<=I.indexOf("-"))throw Error('number format error: interior "-" character');for(var S=c(Math.pow(_,8)),R=f,C=0;C<I.length;C+=8){var x=Math.min(8,I.length-C),A=parseInt(I.substring(C,C+x),_);8>x?(x=c(Math.pow(_,x)),R=R.j(x).add(c(A))):(R=R.j(S),R=R.add(c(A)))}return R}var f=l(0),m=l(1),y=l(16777216);t=o.prototype,t.m=function(){if(P(this))return-k(this).m();for(var I=0,_=1,S=0;S<this.g.length;S++){var R=this.i(S);I+=(0<=R?R:4294967296+R)*_,_*=4294967296}return I},t.toString=function(I){if(I=I||10,2>I||36<I)throw Error("radix out of range: "+I);if(T(this))return"0";if(P(this))return"-"+k(this).toString(I);for(var _=c(Math.pow(I,6)),S=this,R="";;){var C=b(S,_).g;S=w(S,C.j(_));var x=((0<S.g.length?S.g[0]:S.h)>>>0).toString(I);if(S=C,T(S))return x+R;for(;6>x.length;)x="0"+x;R=x+R}},t.i=function(I){return 0>I?0:I<this.g.length?this.g[I]:this.h};function T(I){if(I.h!=0)return!1;for(var _=0;_<I.g.length;_++)if(I.g[_]!=0)return!1;return!0}function P(I){return I.h==-1}t.l=function(I){return I=w(this,I),P(I)?-1:T(I)?0:1};function k(I){for(var _=I.g.length,S=[],R=0;R<_;R++)S[R]=~I.g[R];return new o(S,~I.h).add(m)}t.abs=function(){return P(this)?k(this):this},t.add=function(I){for(var _=Math.max(this.g.length,I.g.length),S=[],R=0,C=0;C<=_;C++){var x=R+(this.i(C)&65535)+(I.i(C)&65535),A=(x>>>16)+(this.i(C)>>>16)+(I.i(C)>>>16);R=A>>>16,x&=65535,A&=65535,S[C]=A<<16|x}return new o(S,S[S.length-1]&-2147483648?-1:0)};function w(I,_){return I.add(k(_))}t.j=function(I){if(T(this)||T(I))return f;if(P(this))return P(I)?k(this).j(k(I)):k(k(this).j(I));if(P(I))return k(this.j(k(I)));if(0>this.l(y)&&0>I.l(y))return c(this.m()*I.m());for(var _=this.g.length+I.g.length,S=[],R=0;R<2*_;R++)S[R]=0;for(R=0;R<this.g.length;R++)for(var C=0;C<I.g.length;C++){var x=this.i(R)>>>16,A=this.i(R)&65535,pt=I.i(C)>>>16,kn=I.i(C)&65535;S[2*R+2*C]+=A*kn,v(S,2*R+2*C),S[2*R+2*C+1]+=x*kn,v(S,2*R+2*C+1),S[2*R+2*C+1]+=A*pt,v(S,2*R+2*C+1),S[2*R+2*C+2]+=x*pt,v(S,2*R+2*C+2)}for(R=0;R<_;R++)S[R]=S[2*R+1]<<16|S[2*R];for(R=_;R<2*_;R++)S[R]=0;return new o(S,0)};function v(I,_){for(;(I[_]&65535)!=I[_];)I[_+1]+=I[_]>>>16,I[_]&=65535,_++}function E(I,_){this.g=I,this.h=_}function b(I,_){if(T(_))throw Error("division by zero");if(T(I))return new E(f,f);if(P(I))return _=b(k(I),_),new E(k(_.g),k(_.h));if(P(_))return _=b(I,k(_)),new E(k(_.g),_.h);if(30<I.g.length){if(P(I)||P(_))throw Error("slowDivide_ only works with positive integers.");for(var S=m,R=_;0>=R.l(I);)S=F(S),R=F(R);var C=U(S,1),x=U(R,1);for(R=U(R,2),S=U(S,2);!T(R);){var A=x.add(R);0>=A.l(I)&&(C=C.add(S),x=A),R=U(R,1),S=U(S,1)}return _=w(I,C.j(_)),new E(C,_)}for(C=f;0<=I.l(_);){for(S=Math.max(1,Math.floor(I.m()/_.m())),R=Math.ceil(Math.log(S)/Math.LN2),R=48>=R?1:Math.pow(2,R-48),x=c(S),A=x.j(_);P(A)||0<A.l(I);)S-=R,x=c(S),A=x.j(_);T(x)&&(x=m),C=C.add(x),I=w(I,A)}return new E(C,I)}t.A=function(I){return b(this,I).h},t.and=function(I){for(var _=Math.max(this.g.length,I.g.length),S=[],R=0;R<_;R++)S[R]=this.i(R)&I.i(R);return new o(S,this.h&I.h)},t.or=function(I){for(var _=Math.max(this.g.length,I.g.length),S=[],R=0;R<_;R++)S[R]=this.i(R)|I.i(R);return new o(S,this.h|I.h)},t.xor=function(I){for(var _=Math.max(this.g.length,I.g.length),S=[],R=0;R<_;R++)S[R]=this.i(R)^I.i(R);return new o(S,this.h^I.h)};function F(I){for(var _=I.g.length+1,S=[],R=0;R<_;R++)S[R]=I.i(R)<<1|I.i(R-1)>>>31;return new o(S,I.h)}function U(I,_){var S=_>>5;_%=32;for(var R=I.g.length-S,C=[],x=0;x<R;x++)C[x]=0<_?I.i(x+S)>>>_|I.i(x+S+1)<<32-_:I.i(x+S);return new o(C,I.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,LR=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=h,gs=o}).apply(typeof CE<"u"?CE:typeof self<"u"?self:typeof window<"u"?window:{});var Uc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Oi(t){if(t.code!==L.FAILED_PRECONDITION||t.message!==KR)throw t;j("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wd{constructor(e,n){this.serializer=e,this.userId=n}static lt(e,n){const r=n.uid||"";return new Wd(e,r)}getOverlay(e,n){return ol(e).get(rI(this.userId,n)).next(r=>r?Sp(this.serializer,r):null)}getOverlays(e,n){const r=er();return D.forEach(n,i=>this.getOverlay(e,i).next(s=>{s!==null&&r.set(i,s)})).next(()=>r)}saveOverlays(e,n,r){const i=[];return r.forEach((s,o)=>{const a=new U_(n,o);i.push(this.ht(e,a))}),D.waitFor(i)}removeOverlaysForBatchId(e,n,r){const i=new Set;n.forEach(o=>i.add(Bt(o.getCollectionPath())));const s=[];return i.forEach(o=>{const a=IDBKeyRange.bound([this.userId,o,r],[this.userId,o,r+1],!1,!0);s.push(ol(e).j("collectionPathOverlayIndex",a))}),D.waitFor(s)}getOverlaysForCollection(e,n,r){const i=er(),s=Bt(n),o=IDBKeyRange.bound([this.userId,s,r],[this.userId,s,Number.POSITIVE_INFINITY],!0);return ol(e).U("collectionPathOverlayIndex",o).next(a=>{for(const l of a){const c=Sp(this.serializer,l);i.set(c.getKey(),c)}return i})}getOverlaysForCollectionGroup(e,n,r,i){const s=er();let o;const a=IDBKeyRange.bound([this.userId,n,r],[this.userId,n,Number.POSITIVE_INFINITY],!0);return ol(e).J({index:"collectionGroupOverlayIndex",range:a},(l,c,h)=>{const f=Sp(this.serializer,c);s.size()<i||f.largestBatchId===o?(s.set(f.getKey(),f),o=f.largestBatchId):h.done()}).next(()=>s)}ht(e,n){return ol(e).put(function(i,s,o){const[a,l,c]=rI(s,o.mutation.key);return{userId:s,collectionPath:l,documentId:c,collectionGroup:o.mutation.key.getCollectionGroup(),largestBatchId:o.largestBatchId,overlayMutation:Iu(i.ct,o.mutation)}}(this.serializer,this.userId,n))}}function ol(t){return dt(t,"documentOverlays")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iP{constructor(){this.$i=!1,this.Ui=!1,this.Wi=100,this.Gi=function(){return TR()?8:YR(Ne())>0?6:4}()}initialize(e,n){this.zi=e,this.indexManager=n,this.$i=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.ji(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.Hi(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new OL;return this.Ji(e,n,o).next(a=>{if(s.result=a,this.Ui)return this.Yi(e,n,o,a.size)})}).next(()=>s.result)}Yi(e,n,r,i){return r.documentReadCount<this.Wi?(ho()<=ie.DEBUG&&j("QueryEngine","SDK will not create cache indexes for query:",fo(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Wi,"documents"),D.resolve()):(ho()<=ie.DEBUG&&j("QueryEngine","Query:",fo(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.Gi*i?(ho()<=ie.DEBUG&&j("QueryEngine","The SDK decides to create cache indexes for query:",fo(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,jt(n))):D.resolve())}ji(e,n){if(WE(n))return D.resolve(null);let r=jt(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=ed(n,null,"F"),r=jt(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=re(...s);return this.zi.getDocuments(e,o).next(a=>this.indexManager.getMinOffset(e,r).next(l=>{const c=this.Zi(n,a);return this.Xi(n,c,o,l.readTime)?this.ji(e,ed(n,null,"F")):this.es(e,c,n,l)}))})))}Hi(e,n,r,i){return WE(n)||i.isEqual(J.min())?D.resolve(null):this.zi.getDocuments(e,r).next(s=>{const o=this.Zi(n,s);return this.Xi(n,o,r,i)?D.resolve(null):(ho()<=ie.DEBUG&&j("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),fo(n)),this.es(e,o,n,GR(i,-1)).next(a=>a))})}Zi(e,n){let r=new ve(_A(e));return n.forEach((i,s)=>{Uu(e,s)&&(r=r.add(s))}),r}Xi(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Ji(e,n,r){return ho()<=ie.DEBUG&&j("QueryEngine","Using full collection scan to execute query:",fo(n)),this.zi.getDocumentsMatchingQuery(e,n,fn.min(),r)}es(e,n,r,i){return this.zi.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lr{constructor(e){this._byteString=e}static fromBase64String(e){try{return new lr(rt.fromBase64String(e))}catch(n){throw new B(L.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new lr(rt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ki=class{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new B(L.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Ce(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zd{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new B(L.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new B(L.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return ne(this._lat,e._lat)||ne(this._long,e._long)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function aU(t,e,n){const r=We(t),i={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function s(o,a){$(a.handleCodeInApp,r,"argument-error"),a&&pf(r,o,a)}s(i,n),await Au(r,i,"getOobCode",U2)}function lU(t,e){const n=hf.parseLink(e);return(n==null?void 0:n.operation)==="EMAIL_SIGNIN"}async function uU(t,e,n){if(ze(t.app))return Promise.reject(ct(t));const r=Y(t),i=Fi.credentialWithLink(e,n||Su());return $(i._tenantId===(r.tenantId||null),r,"tenant-id-mismatch"),ff(r,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kt{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=kt.makeFromUrl(e,n)}catch{return new kt(e,"")}if(r.path==="")return r;throw _j(e)}static makeFromUrl(e,n){let r=null;const i="([A-Za-z0-9.\\-_]+)";function s(b){b.path.charAt(b.path.length-1)==="/"&&(b.path_=b.path_.slice(0,-1))}const o="(/(.*))?$",a=new RegExp("^gs://"+i+o,"i"),l={bucket:1,path:3};function c(b){b.path_=decodeURIComponent(b.path)}const h="v[A-Za-z0-9_]+",f=n.replace(/[.]/g,"\\."),m="(/([^?#]*).*)?$",y=new RegExp(`^https?://${f}/${h}/b/${i}/o${m}`,"i"),T={bucket:1,path:3},P=n===fC?"(?:storage.googleapis.com|storage.cloud.google.com)":n,k="([^?#]*)",w=new RegExp(`^https?://${P}/${i}/${k}`,"i"),E=[{regex:a,indices:l,postModify:s},{regex:y,indices:T,postModify:c},{regex:w,indices:{bucket:1,path:2},postModify:c}];for(let b=0;b<E.length;b++){const F=E[b],U=F.regex.exec(e);if(U){const I=U[F.indices.bucket];let _=U[F.indices.path];_||(_=""),r=new kt(I,_),F.postModify(r);break}}if(r==null)throw gj(e);return r}}class Ij{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tj(t,e,n){let r=1,i=null,s=null,o=!1,a=0;function l(){return a===2}let c=!1;function h(...k){c||(c=!0,e.apply(null,k))}function f(k){i=setTimeout(()=>{i=null,t(y,l())},k)}function m(){s&&clearTimeout(s)}function y(k,...w){if(c){m();return}if(k){m(),h.call(null,k,...w);return}if(l()||o){m(),h.call(null,k,...w);return}r<64&&(r*=2);let E;a===1?(a=2,E=0):E=(r+Math.random())*1e3,f(E)}let T=!1;function P(k){T||(T=!0,m(),!c&&(i!==null?(k||(a=2),clearTimeout(i),f(0)):k||(a=1)))}return f(0),s=setTimeout(()=>{o=!0,P(!0)},n),P}function Sj(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oz="storage-compat";function Vz(t,{instanceIdentifier:e}){const n=t.getProvider("app-compat").getImmediate(),r=t.getProvider("storage").getImmediate({identifier:e});return new BC(n,r)}function Lz(t){const e={TaskState:Ft,TaskEvent:az,StringFormat:En,Storage:BC,Reference:Rr};t.INTERNAL.registerComponent(new An(Oz,Vz,"PUBLIC").setServiceProps(e).setMultipleInstances(!0)),t.registerVersion(Nz,Dz)}Lz(Hs);const rv=Hs.initializeApp({apiKey:"AIzaSyAp9XrnMQ2kd-L8I2kVOZJctYBAT-h66tM",authDomain:"polanco-25ef9.firebaseapp.com",projectId:"polanco-25ef9",storageBucket:"polanco-25ef9.appspot.com",messagingSenderId:"804200542961",appId:"1:804200542961:web:010ee2a2d4e45ec098af50"}),iv=u4(rv),co=JM(rv),yT=Cz(rv),sv=V.createContext(),Mz=t=>{const[e,n]=V.useState([]),[r,i]=V.useState([]),[s,o]=V.useState(!1),a=Wn(Bl(co,"orders"),gh("takenByCustomer","==",s),gh("city","==","hermosillo")),[l,c]=V.useState(!0);V.useEffect(()=>{ug(a).then(k=>{k.size===0&&console.log("No results!");const w=k.docs.map(v=>({id:v.id,...v.data()}));n(w)}).catch(k=>{console.log("Error searching items",k)})},[l]);const h=Wn(Bl(co,"inventario"),gh("sucursal","==","Hermosillo"));V.useEffect(()=>{ug(h).then(k=>{k.size===0&&console.log("No results!");const w=k.docs.map(v=>({id:v.id,...v.data()}));i(w)}).catch(k=>{console.log("Error searching items",k)})},[l]);const f=Bl(co,"inventario"),m=(k,w)=>{const v=gd(yT,`projectFiles/${k==null?void 0:k.name}`);Iz(v,k).then(()=>{MC(v).then(E=>{w.imgName=k.name,w.imgUrl=E,ik(f,w),c(!l)})}).catch(E=>console.log(E))},y=async(k,w)=>{const v=_s(co,"inventario",k);try{await rk(v);const E=gd(yT,`projectFiles/${w}`);FC(E).then(()=>{console.log(w,"se elimino de Storage")}).catch(b=>{console.log("ocurrio un error: ",b)})}catch(E){console.error(E)}},T=async(k,w)=>{const v=_s(co,"orders",k);try{await ud(v,w)}catch(E){console.error(E)}},P=async(k,w)=>{const v=_s(co,"inventario",k);try{await ud(v,w)}catch(E){console.error(E)}};return O.jsx(sv.Provider,{value:{items:e,deleteById:y,UpdateById:T,handleFileAdd:m,setToggle:c,toggle:l,toggleOrders:s,setToggleOrders:o,UpdateByIdInventario:P,itemsInventario:r},children:t.children})},Fz=({items:t,UpdateById:e,UpdateByIdInventario:n})=>{const{deleteById:r,setToggle:i,toggle:s,toggleOrders:o,setToggleOrders:a,itemsInventario:l}=V.useContext(sv);V.useState("");const[c,h]=V.useState({});console.log(c);let f=new Date;f.setHours(f.getHours());const m=(T,P)=>{const k=P;k.takenByCustomer=!0,e(T,k),i(!s)},y=()=>{a(!o),i(!s)};return O.jsxs("div",{className:"card p-4",children:[O.jsx("h3",{className:"text-white mb-4",children:"ORDENES DE HERMOSILLO"}),O.jsxs("button",{className:"btn btn-info ",onClick:y,children:[" ",o?"Entregados":"Por Entregar"," "]}),t.map((T,P)=>O.jsxs("div",{className:"item",children:[O.jsx("hr",{}),O.jsxs("div",{className:"texto",children:[O.jsxs("h3",{children:["Comprador: ",T.buyer.name]}),O.jsxs("p",{children:["Fecha de Compra:"," ",new Date(T.date).toLocaleDateString("es-ES",{year:"numeric",month:"long",day:"numeric"})]}),T.items.map((k,w)=>O.jsxs("b",{children:[O.jsxs("h6",{children:["id ",k.id]}),O.jsx("img",{style:{width:"100px"},src:k.imgUrl}),"- Cantidad: ",k.quantity," ",O.jsx("br",{})]},w)),O.jsx("br",{}),O.jsxs("p",{children:["Correo: ",T.buyer.email]}),O.jsxs("p",{children:["Celular: ",T.buyer.phone]}),O.jsxs("p",{children:["Ciudad: ",T.city]}),O.jsxs("p",{className:"m-0",children:["Total: ",T.total]}),O.jsx("br",{})]}),O.jsx("br",{}),O.jsx("button",{disabled:T.takenByCustomer===!0,className:T.takenByCustomer===!0?"btn btn-outline-primary mt-0":"btn btn-primary mt-4",onClick:()=>m(T.id,T),children:T.takenByCustomer?"Entregado":"Marcar como Entregada"}),O.jsx("hr",{})]},P))]})},nc=V.createContext(),Uz=t=>{const e=async(o,a,l)=>{try{await Ok(o,a,l),i(o,a,l)}catch(c){console.error("code.error",c.code);const h={"auth/email-already-in-use":()=>alert("El Correo ya esta en Uso"),"auth/operation-not-allowed":()=>alert("Operacion No Permitida."),"auth/weak-password":()=>alert("La contraseña es muy débil."),"auth/invalid-email":()=>alert("El Correo No es Valido")};(m=>{h[m]()})(c.code)}},[n,r]=V.useState(!0),i=(o,a,l)=>{Vk(o,a,l).then(c=>{const h=c.user;localStorage.setItem("userEmailLS",h.email),r(!n),location.reload()}).catch(c=>{console.log(c.code),console.log(c.message),c.code=="auth/invalid-credential"&&alert("Contraseña o Correo son Incorrrectos")})},s=()=>{AU(iv),localStorage.removeItem("userEmailLS"),r(!n)};return O.jsx(nc.Provider,{value:{register:e,login:i,logout:s,stateLogout:n},children:t.children})},Bz=()=>{const{items:t,UpdateById:e,UpdateByIdInventario:n}=V.useContext(sv),{stateLogout:r}=V.useContext(nc);return console.log(t),O.jsx("div",{className:"",children:r?O.jsx("div",{className:"",children:localStorage.getItem("userEmailLS")!==null?O.jsx(Fz,{items:t,UpdateById:e,UpdateByIdInventario:n},Date.now()):O.jsx("p",{children:"Holis"})}):""})},jz=()=>{const{login:t}=V.useContext(nc),[e,n]=V.useState(!1),r=V.useRef(),i=V.useRef(),s=()=>n(!0),o=()=>n(!1),a=l=>{l.preventDefault(),localStorage.removeItem("Done"),t(iv,r.current.value,i.current.value),o()};return O.jsxs(O.Fragment,{children:[O.jsx("div",{onClick:s,className:"btn btn-outline-primary mx-2",children:"Entrar"}),O.jsx(Hn,{centered:!0,show:e,onHide:o,children:O.jsxs("form",{onSubmit:a,children:[O.jsx(Hn.Header,{children:O.jsx(Hn.Title,{children:"Entrar"})}),O.jsxs(Hn.Body,{children:[O.jsxs(Vt.Group,{children:[O.jsx(Vt.Label,{children:"Email "}),O.jsx(Vt.Control,{type:"email",required:!0,ref:r})]}),O.jsxs(Vt.Group,{children:[O.jsx(Vt.Label,{children:"Password"}),O.jsx(Vt.Control,{type:"password",required:!0,ref:i})]})]}),O.jsxs(Hn.Footer,{children:[O.jsx(cu,{variant:"secondary",onClick:o,children:" Cancelar "}),O.jsx(cu,{variant:"primary",type:"submit",children:"         Entrar "})]})]})})]})},zz=()=>{const{register:t}=V.useContext(nc),[e,n]=V.useState(!1),[r,i]=V.useState(""),s=V.useRef(),o=V.useRef(),a=V.useRef(),l=()=>n(!0),c=()=>{i(""),n(!1)},h=async f=>{if(f.preventDefault(),i(""),o.current.value!==a.current.value)return i("Claves No son iguales.");if(o.current.value.length<6)return i("Claves es muy corta Use 6 caracteres Minimo");t(iv,s.current.value,o.current.value),c()};return O.jsxs(O.Fragment,{children:[O.jsx("div",{onClick:l,className:"btn btn-outline-primary mx-2 d-none",children:"Registro"}),O.jsx(Hn,{centered:!0,show:e,onHide:c,children:O.jsxs("form",{onSubmit:h,children:[O.jsx(Hn.Header,{children:O.jsx(Hn.Title,{children:"Registro"})}),O.jsxs(Hn.Body,{children:[r&&O.jsx(xN,{variant:"danger",children:r}),O.jsxs(Vt.Group,{children:[O.jsx(Vt.Label,{children:"Email"}),O.jsx(Vt.Control,{type:"email",required:!0,ref:s})]}),O.jsxs(Vt.Group,{children:[O.jsx(Vt.Label,{children:"Password"}),O.jsx(Vt.Control,{type:"password",required:!0,ref:o})]}),O.jsxs(Vt.Group,{children:[O.jsx(Vt.Label,{children:"Confirmar Password"}),O.jsx(Vt.Control,{type:"password",required:!0,ref:a})]})]}),O.jsxs(Hn.Footer,{children:[O.jsx(cu,{variant:"secondary",onClick:c,children:" Cancelar "}),O.jsx(cu,{variant:"primary",type:"submit",children:" Registro "})]})]})})]})},$z=()=>{const{logout:t,stateLogout:e}=V.useContext(nc);return O.jsxs("nav",{className:"container w-100",children:[O.jsx("div",{className:"w-100 border-bottom pt-1",children:O.jsx("div",{className:"mb-4 d-flex justify-content-between",children:localStorage.getItem("userEmailLS")!==null?O.jsxs(O.Fragment,{children:[O.jsx("div",{className:"btn btn-primary mx-2 disabled",children:localStorage.getItem("userEmailLS")}),O.jsx("div",{onClick:()=>{window.confirm("Quieres Salir?")&&t()},className:"btn btn-outline-danger mx-2",children:"SALIR"})]}):O.jsxs(O.Fragment,{children:[O.jsx(jz,{}),O.jsx(zz,{})]})})}),O.jsx("div",{className:"w-100 d-flex justify-content-center",children:O.jsxs("div",{className:"navbar-brand mb-4 text-center",children:[O.jsx("h2",{className:"",children:"PUNTO DE VENTA HERMOSILLO"}),O.jsx("h3",{children:"POLANCO GUAYABERAS"})]})})]})},qz=()=>O.jsx(O.Fragment,{children:O.jsx(Uz,{children:O.jsxs(Mz,{children:[O.jsx($z,{}),O.jsx(Bz,{})]})})});Mp.createRoot(document.getElementById("root")).render(O.jsx(qz,{}));
