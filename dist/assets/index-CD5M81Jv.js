...
*/var gs,VR;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(w,y){function T(){}T.prototype=y.prototype,w.D=y.prototype,w.prototype=new T,w.prototype.constructor=w,w.C=function(R,k,x){for(var A=Array(arguments.length-2),pt=2;pt<arguments.length;pt++)A[pt-2]=arguments[pt];return y.prototype[k].apply(R,A)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(w,y,T){T||(T=0);var R=Array(16);if(typeof y=="string")for(var k=0;16>k;++k)R[k]=y.charCodeAt(T++)|y.charCodeAt(T++)<<8|y.charCodeAt(T++)<<16|y.charCodeAt(T++)<<24;else for(k=0;16>k;++k)R[k]=y[T++]|y[T++]<<8|y[T++]<<16|y[T++]<<24;y=w.g[0],T=w.g[1],k=w.g[2];var x=w.g[3],A=y+(x^T&(k^x))+R[0]+3614090360&4294967295;y=T+(A<<7&4294967295|A>>>25),A=x+(k^y&(T^k))+R[1]+3905402710&4294967295,x=y+(A<<12&4294967295|A>>>20),A=k+(T^x&(y^T))+R[2]+606105819&4294967295,k=x+(A<<17&4294967295|A>>>15),A=T+(y^k&(x^y))+R[3]+3250441966&4294967295,T=k+(A<<22&4294967295|A>>>10),A=y+(x^T&(k^x))+R[4]+4118548399&4294967295,y=T+(A<<7&4294967295|A>>>25),A=x+(k^y&(T^k))+R[5]+1200080426&4294967295,x=y+(A<<12&4294967295|A>>>20),A=k+(T^x&(y^T))+R[6]+2821735955&4294967295,k=x+(A<<17&4294967295|A>>>15),A=T+(y^k&(x^y))+R[7]+4249261313&4294967295,T=k+(A<<22&4294967295|A>>>10),A=y+(x^T&(k^x))+R[8]+1770035416&4294967295,y=T+(A<<7&4294967295|A>>>25),A=x+(k^y&(T^k))+R[9]+2336552879&4294967295,x=y+(A<<12&4294967295|A>>>20),A=k+(T^x&(y^T))+R[10]+4294925233&4294967295,k=x+(A<<17&4294967295|A>>>15),A=T+(y^k&(x^y))+R[11]+2304563134&4294967295,T=k+(A<<22&4294967295|A>>>10),A=y+(x^T&(k^x))+R[12]+1804603682&4294967295,y=T+(A<<7&4294967295|A>>>25),A=x+(k^y&(T^k))+R[13]+4254626195&4294967295,x=y+(A<<12&4294967295|A>>>20),A=k+(T^x&(y^T))+R[14]+2792965006&4294967295,k=x+(A<<17&4294967295|A>>>15),A=T+(y^k&(x^y))+R[15]+1236535329&4294967295,T=k+(A<<22&4294967295|A>>>10),A=y+(k^x&(T^k))+R[1]+4129170786&4294967295,y=T+(A<<5&4294967295|A>>>27),A=x+(T^k&(y^T))+R[6]+3225465664&4294967295,x=y+(A<<9&4294967295|A>>>23),A=k+(y^T&(x^y))+R[11]+643717713&4294967295,k=x+(A<<14&4294967295|A>>>18),A=T+(x^y&(k^x))+R[0]+3921069994&4294967295,T=k+(A<<20&4294967295|A>>>12),A=y+(k^x&(T^k))+R[5]+3593408605&4294967295,y=T+(A<<5&4294967295|A>>>27),A=x+(T^k&(y^T))+R[10]+38016083&4294967295,x=y+(A<<9&4294967295|A>>>23),A=k+(y^T&(x^y))+R[15]+3634488961&4294967295,k=x+(A<<14&4294967295|A>>>18),A=T+(x^y&(k^x))+R[4]+3889429448&4294967295,T=k+(A<<20&4294967295|A>>>12),A=y+(k^x&(T^k))+R[9]+568446438&4294967295,y=T+(A<<5&4294967295|A>>>27),A=x+(T^k&(y^T))+R[14]+3275163606&4294967295,x=y+(A<<9&4294967295|A>>>23),A=k+(y^T&(x^y))+R[3]+4107603335&4294967295,k=x+(A<<14&4294967295|A>>>18),A=T+(x^y&(k^x))+R[8]+1163531501&4294967295,T=k+(A<<20&4294967295|A>>>12),A=y+(k^x&(T^k))+R[13]+2850285829&4294967295,y=T+(A<<5&4294967295|A>>>27),A=x+(T^k&(y^T))+R[2]+4243563512&4294967295,x=y+(A<<9&4294967295|A>>>23),A=k+(y^T&(x^y))+R[7]+1735328473&4294967295,k=x+(A<<14&4294967295|A>>>18),A=T+(x^y&(k^x))+R[12]+2368359562&4294967295,T=k+(A<<20&4294967295|A>>>12),A=y+(T^k^x)+R[5]+4294588738&4294967295,y=T+(A<<4&4294967295|A>>>28),A=x+(y^T^k)+R[8]+2272392833&4294967295,x=y+(A<<11&4294967295|A>>>21),A=k+(x^y^T)+R[11]+1839030562&4294967295,k=x+(A<<16&4294967295|A>>>16),A=T+(k^x^y)+R[14]+4259657740&4294967295,T=k+(A<<23&4294967295|A>>>9),A=y+(T^k^x)+R[1]+2763975236&4294967295,y=T+(A<<4&4294967295|A>>>28),A=x+(y^T^k)+R[4]+1272893353&4294967295,x=y+(A<<11&4294967295|A>>>21),A=k+(x^y^T)+R[7]+4139469664&4294967295,k=x+(A<<16&4294967295|A>>>16),A=T+(k^x^y)+R[10]+3200236656&4294967295,T=k+(A<<23&4294967295|A>>>9),A=y+(T^k^x)+R[13]+681279174&4294967295,y=T+(A<<4&4294967295|A>>>28),A=x+(y^T^k)+R[0]+3936430074&4294967295,x=y+(A<<11&4294967295|A>>>21),A=k+(x^y^T)+R[3]+3572445317&4294967295,k=x+(A<<16&4294967295|A>>>16),A=T+(k^x^y)+R[6]+76029189&4294967295,T=k+(A<<23&4294967295|A>>>9),A=y+(T^k^x)+R[9]+3654602809&4294967295,y=T+(A<<4&4294967295|A>>>28),A=x+(y^T^k)+R[12]+3873151461&4294967295,x=y+(A<<11&4294967295|A>>>21),A=k+(x^y^T)+R[15]+530742520&4294967295,k=x+(A<<16&4294967295|A>>>16),A=T+(k^x^y)+R[2]+3299628645&4294967295,T=k+(A<<23&4294967295|A>>>9),A=y+(k^(T|~x))+R[0]+4096336452&4294967295,y=T+(A<<6&4294967295|A>>>26),A=x+(T^(y|~k))+R[7]+1126891415&4294967295,x=y+(A<<10&4294967295|A>>>22),A=k+(y^(x|~T))+R[14]+2878612391&4294967295,k=x+(A<<15&4294967295|A>>>17),A=T+(x^(k|~y))+R[5]+4237533241&4294967295,T=k+(A<<21&4294967295|A>>>11),A=y+(k^(T|~x))+R[12]+1700485571&4294967295,y=T+(A<<6&4294967295|A>>>26),A=x+(T^(y|~k))+R[3]+2399980690&4294967295,x=y+(A<<10&4294967295|A>>>22),A=k+(y^(x|~T))+R[10]+4293915773&4294967295,k=x+(A<<15&4294967295|A>>>17),A=T+(x^(k|~y))+R[1]+2240044497&4294967295,T=k+(A<<21&4294967295|A>>>11),A=y+(k^(T|~x))+R[8]+1873313359&4294967295,y=T+(A<<6&4294967295|A>>>26),A=x+(T^(y|~k))+R[15]+4264355552&4294967295,x=y+(A<<10&4294967295|A>>>22),A=k+(y^(x|~T))+R[6]+2734768916&4294967295,k=x+(A<<15&4294967295|A>>>17),A=T+(x^(k|~y))+R[13]+1309151649&4294967295,T=k+(A<<21&4294967295|A>>>11),A=y+(k^(T|~x))+R[4]+4149444226&4294967295,y=T+(A<<6&4294967295|A>>>26),A=x+(T^(y|~k))+R[11]+3174756917&4294967295,x=y+(A<<10&4294967295|A>>>22),A=k+(y^(x|~T))+R[2]+718787259&4294967295,k=x+(A<<15&4294967295|A>>>17),A=T+(x^(k|~y))+R[9]+3951481745&4294967295,w.g[0]=w.g[0]+y&4294967295,w.g[1]=w.g[1]+(k+(A<<21&4294967295|A>>>11))&4294967295,w.g[2]=w.g[2]+k&4294967295,w.g[3]=w.g[3]+x&4294967295}r.prototype.u=function(w,y){y===void 0&&(y=w.length);for(var T=y-this.blockSize,R=this.B,k=this.h,x=0;x<y;){if(k==0)for(;x<=T;)i(this,w,x),x+=this.blockSize;if(typeof w=="string"){for(;x<y;)if(R[k++]=w.charCodeAt(x++),k==this.blockSize){i(this,R),k=0;break}}else for(;x<y;)if(R[k++]=w[x++],k==this.blockSize){i(this,R),k=0;break}}this.h=k,this.o+=y},r.prototype.v=function(){var w=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);w[0]=128;for(var y=1;y<w.length-8;++y)w[y]=0;var T=8*this.o;for(y=w.length-8;y<w.length;++y)w[y]=T&255,T/=256;for(this.u(w),w=Array(16),y=T=0;4>y;++y)for(var R=0;32>R;R+=8)w[T++]=this.g[y]>>>R&255;return w};function s(w,y){var T=a;return Object.prototype.hasOwnProperty.call(T,w)?T[w]:T[w]=y(w)}function o(w,y){this.h=y;for(var T=[],R=!0,k=w.length-1;0<=k;k--){var x=w[k]|0;R&&x==y||(T[k]=x,R=!1)}this.g=T}var a={};function l(w){return-128<=w&&128>w?s(w,function(y){return new o([y|0],0>y?-1:0)}):new o([w|0],0>w?-1:0)}function c(w){if(isNaN(w)||!isFinite(w))return f;if(0>w)return b(c(-w));for(var y=[],T=1,R=0;w>=T;R++)y[R]=w/T|0,T*=4294967296;return new o(y,0)}function h(w,y){if(w.length==0)throw Error("number format error: empty string");if(y=y||10,2>y||36<y)throw Error("radix out of range: "+y);if(w.charAt(0)=="-")return b(h(w.substring(1),y));if(0<=w.indexOf("-"))throw Error('number format error: interior "-" character');for(var T=c(Math.pow(y,8)),R=f,k=0;k<w.length;k+=8){var x=Math.min(8,w.length-k),A=parseInt(w.substring(k,k+x),y);8>x?(x=c(Math.pow(y,x)),R=R.j(x).add(c(A))):(R=R.j(T),R=R.add(c(A)))}return R}var f=l(0),m=l(1),_=l(16777216);t=o.prototype,t.m=function(){if(P(this))return-b(this).m();for(var w=0,y=1,T=0;T<this.g.length;T++){var R=this.i(T);w+=(0<=R?R:4294967296+R)*y,y*=4294967296}return w},t.toString=function(w){if(w=w||10,2>w||36<w)throw Error("radix out of range: "+w);if(S(this))return"0";if(P(this))return"-"+b(this).toString(w);for(var y=c(Math.pow(w,6)),T=this,R="";;){var k=C(T,y).g;T=E(T,k.j(y));var x=((0<T.g.length?T.g[0]:T.h)>>>0).toString(w);if(T=k,S(T))return x+R;for(;6>x.length;)x="0"+x;R=x+R}},t.i=function(w){return 0>w?0:w<this.g.length?this.g[w]:this.h};function S(w){if(w.h!=0)return!1;for(var y=0;y<w.g.length;y++)if(w.g[y]!=0)return!1;return!0}function P(w){return w.h==-1}t.l=function(w){return w=E(this,w),P(w)?-1:S(w)?0:1};function b(w){for(var y=w.g.length,T=[],R=0;R<y;R++)T[R]=~w.g[R];return new o(T,~w.h).add(m)}t.abs=function(){return P(this)?b(this):this},t.add=function(w){for(var y=Math.max(this.g.length,w.g.length),T=[],R=0,k=0;k<=y;k++){var x=R+(this.i(k)&65535)+(w.i(k)&65535),A=(x>>>16)+(this.i(k)>>>16)+(w.i(k)>>>16);R=A>>>16,x&=65535,A&=65535,T[k]=A<<16|x}return new o(T,T[T.length-1]&-2147483648?-1:0)};function E(w,y){return w.add(b(y))}t.j=function(w){if(S(this)||S(w))return f;if(P(this))return P(w)?b(this).j(b(w)):b(b(this).j(w));if(P(w))return b(this.j(b(w)));if(0>this.l(_)&&0>w.l(_))return c(this.m()*w.m());for(var y=this.g.length+w.g.length,T=[],R=0;R<2*y;R++)T[R]=0;for(R=0;R<this.g.length;R++)for(var k=0;k<w.g.length;k++){var x=this.i(R)>>>16,A=this.i(R)&65535,pt=w.i(k)>>>16,kn=w.i(k)&65535;T[2*R+2*k]+=A*kn,v(T,2*R+2*k),T[2*R+2*k+1]+=x*kn,v(T,2*R+2*k+1),T[2*R+2*k+1]+=A*pt,v(T,2*R+2*k+1),T[2*R+2*k+2]+=x*pt,v(T,2*R+2*k+2)}for(R=0;R<y;R++)T[R]=T[2*R+1]<<16|T[2*R];for(R=y;R<2*y;R++)T[R]=0;return new o(T,0)};function v(w,y){for(;(w[y]&65535)!=w[y];)w[y+1]+=w[y]>>>16,w[y]&=65535,y++}function I(w,y){this.g=w,this.h=y}function C(w,y){if(S(y))throw Error("division by zero");if(S(w))return new I(f,f);if(P(w))return y=C(b(w),y),new I(b(y.g),b(y.h));if(P(y))return y=C(w,b(y)),new I(b(y.g),y.h);if(30<w.g.length){if(P(w)||P(y))throw Error("slowDivide_ only works with positive integers.");for(var T=m,R=y;0>=R.l(w);)T=F(T),R=F(R);var k=U(T,1),x=U(R,1);for(R=U(R,2),T=U(T,2);!S(R);){var A=x.add(R);0>=A.l(w)&&(k=k.add(T),x=A),R=U(R,1),T=U(T,1)}return y=E(w,k.j(y)),new I(k,y)}for(k=f;0<=w.l(y);){for(T=Math.max(1,Math.floor(w.m()/y.m())),R=Math.ceil(Math.log(T)/Math.LN2),R=48>=R?1:Math.pow(2,R-48),x=c(T),A=x.j(y);P(A)||0<A.l(w);)T-=R,x=c(T),A=x.j(y);S(x)&&(x=m),k=k.add(x),w=E(w,A)}return new I(k,w)}t.A=function(w){return C(this,w).h},t.and=function(w){for(var y=Math.max(this.g.length,w.g.length),T=[],R=0;R<y;R++)T[R]=this.i(R)&w.i(R);return new o(T,this.h&w.h)},t.or=function(w){for(var y=Math.max(this.g.length,w.g.length),T=[],R=0;R<y;R++)T[R]=this.i(R)|w.i(R);return new o(T,this.h|w.h)},t.xor=function(w){for(var y=Math.max(this.g.length,w.g.length),T=[],R=0;R<y;R++)T[R]=this.i(R)^w.i(R);return new o(T,this.h^w.h)};function F(w){for(var y=w.g.length+1,T=[],R=0;R<y;R++)T[R]=w.i(R)<<1|w.i(R-1)>>>31;return new o(T,w.h)}function U(w,y){var T=y>>5;y%=32;for(var R=w.g.length-T,k=[],x=0;x<R;x++)k[x]=0<y?w.i(x+T)>>>y|w.i(x+T+1)<<32-y:w.i(x+T);return new o(k,w.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,VR=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=h,gs=o}).apply(typeof kE<"u"?kE:typeof self<"u"?self:typeof window<"u"?window:{});var Mc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kt{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=kt.makeFromUrl(e,n)}catch{return new kt(e,"")}if(r.path==="")return r;throw _j(e)}static makeFromUrl(e,n){let r=null;const i="([A-Za-z0-9.\\-_]+)";function s(C){C.path.charAt(C.path.length-1)==="/"&&(C.path_=C.path_.slice(0,-1))}const o="(/(.*))?$",a=new RegExp("^gs://"+i+o,"i"),l={bucket:1,path:3};function c(C){C.path_=decodeURIComponent(C.path)}const h="v[A-Za-z0-9_]+",f=n.replace(/[.]/g,"\\."),m="(/([^?#]*).*)?$",_=new RegExp(`^https?://${f}/${h}/b/${i}/o${m}`,"i"),S={bucket:1,path:3},P=n===fC?"(?:storage.googleapis.com|storage.cloud.google.com)":n,b="([^?#]*)",E=new RegExp(`^https?://${P}/${i}/${b}`,"i"),I=[{regex:a,indices:l,postModify:s},{regex:_,indices:S,postModify:c},{regex:E,indices:{bucket:1,path:2},postModify:c}];for(let C=0;C<I.length;C++){const F=I[C],U=F.regex.exec(e);if(U){const w=U[F.indices.bucket];let y=U[F.indices.path];y||(y=""),r=new kt(w,y),F.postModify(r);break}}if(r==null)throw gj(e);return r}}class Ij{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tj(t,e,n){let r=1,i=null,s=null,o=!1,a=0;function l(){return a===2}let c=!1;function h(...b){c||(c=!0,e.apply(null,b))}function f(b){i=setTimeout(()=>{i=null,t(_,l())},b)}function m(){s&&clearTimeout(s)}function _(b,...E){if(c){m();return}if(b){m(),h.call(null,b,...E);return}if(l()||o){m(),h.call(null,b,...E);return}r<64&&(r*=2);let I;a===1?(a=2,I=0):I=(r+Math.random())*1e3,f(I)}let S=!1;function P(b){S||(S=!0,m(),!c&&(i!==null?(b||(a=2),clearTimeout(i),f(0)):b||(a=1)))}return f(0),s=setTimeout(()=>{o=!0,P(!0)},n),P}function Sj(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,m=`\r
--`+l+"--",_=Xn.getBlob(f,r,m);if(_===null)throw _C();const S={name:c.fullPath},P=Bi(s,t.host,t._protocol),b="POST",E=t.maxUploadRetryTime,v=new $r(P,b,wf(t,n),E);return v.urlParams=S,v.headers=o,v.body=_.uploadData(),v.errorHandler=Da(e),v}class fd{constructor(e,n,r,i){this.current=e,this.total=n,this.finalized=!!r,this.metadata=i||null}}function ev(t,e){let n=null;try{n=t.getResponseHeader("X-Goog-Upload-Status")}catch{sr(!1)}return sr(!!n&&(e||["active"]).indexOf(n)!==-1),n}function iz(t,e,n,r,i){const s=e.bucketOnlyServerUrl(),o=CC(e,r,i),a={name:o.fullPath},l=Bi(s,t.host,t._protocol),c="POST",h={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${r.size()}`,"X-Goog-Upload-Header-Content-Type":o.contentType,"Content-Type":"application/json; charset=utf-8"},f=Zy(o,n),m=t.maxUploadRetryTime;function _(P){ev(P);let b;try{b=P.getResponseHeader("X-Goog-Upload-URL")}catch{sr(!1)}return sr(vf(b)),b}const S=new $r(l,c,_,m);return S.urlParams=a,S.headers=h,S.body=f,S.errorHandler=Da(e),S}function sz(t,e,n,r){const i={"X-Goog-Upload-Command":"query"};function s(c){const h=ev(c,["active","final"]);let f=null;try{f=c.getResponseHeader("X-Goog-Upload-Size-Received")}catch{sr(!1)}f||sr(!1);const m=Number(f);return sr(!isNaN(m)),new fd(m,r.size(),h==="final")}const o="POST",a=t.maxUploadRetryTime,l=new $r(n,o,s,a);return l.headers=i,l.errorHandler=Da(e),l}const cT=256*1024;function oz(t,e,n,r,i,s,o,a){const l=new fd(0,0);if(o?(l.current=o.current,l.total=o.total):(l.current=0,l.total=r.size()),r.size()!==l.total)throw vj();const c=l.total-l.current;let h=c;i>0&&(h=Math.min(h,i));const f=l.current,m=f+h;let _="";h===0?_="finalize":c===h?_="upload, finalize":_="upload";const S={"X-Goog-Upload-Command":_,"X-Goog-Upload-Offset":`${l.current}`},P=r.slice(f,m);if(P===null)throw _C();function b(C,F){const U=ev(C,["active","final"]),w=l.current+h,y=r.size();let T;return U==="final"?T=wf(e,s)(C,F):T=null,new fd(w,y,U==="final",T)}const E="POST",v=e.maxUploadRetryTime,I=new $r(n,E,b,v);return I.headers=S,I.body=P.uploadData(),I.progressCallback=a||null,I.errorHandler=Da(t),I}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
