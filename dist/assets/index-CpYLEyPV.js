...
*/var gs,LR;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(E,_){function T(){}T.prototype=_.prototype,E.D=_.prototype,E.prototype=new T,E.prototype.constructor=E,E.C=function(R,b,x){for(var A=Array(arguments.length-2),pt=2;pt<arguments.length;pt++)A[pt-2]=arguments[pt];return _.prototype[b].apply(R,A)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(E,_,T){T||(T=0);var R=Array(16);if(typeof _=="string")for(var b=0;16>b;++b)R[b]=_.charCodeAt(T++)|_.charCodeAt(T++)<<8|_.charCodeAt(T++)<<16|_.charCodeAt(T++)<<24;else for(b=0;16>b;++b)R[b]=_[T++]|_[T++]<<8|_[T++]<<16|_[T++]<<24;_=E.g[0],T=E.g[1],b=E.g[2];var x=E.g[3],A=_+(x^T&(b^x))+R[0]+3614090360&4294967295;_=T+(A<<7&4294967295|A>>>25),A=x+(b^_&(T^b))+R[1]+3905402710&4294967295,x=_+(A<<12&4294967295|A>>>20),A=b+(T^x&(_^T))+R[2]+606105819&4294967295,b=x+(A<<17&4294967295|A>>>15),A=T+(_^b&(x^_))+R[3]+3250441966&4294967295,T=b+(A<<22&4294967295|A>>>10),A=_+(x^T&(b^x))+R[4]+4118548399&4294967295,_=T+(A<<7&4294967295|A>>>25),A=x+(b^_&(T^b))+R[5]+1200080426&4294967295,x=_+(A<<12&4294967295|A>>>20),A=b+(T^x&(_^T))+R[6]+2821735955&4294967295,b=x+(A<<17&4294967295|A>>>15),A=T+(_^b&(x^_))+R[7]+4249261313&4294967295,T=b+(A<<22&4294967295|A>>>10),A=_+(x^T&(b^x))+R[8]+1770035416&4294967295,_=T+(A<<7&4294967295|A>>>25),A=x+(b^_&(T^b))+R[9]+2336552879&4294967295,x=_+(A<<12&4294967295|A>>>20),A=b+(T^x&(_^T))+R[10]+4294925233&4294967295,b=x+(A<<17&4294967295|A>>>15),A=T+(_^b&(x^_))+R[11]+2304563134&4294967295,T=b+(A<<22&4294967295|A>>>10),A=_+(x^T&(b^x))+R[12]+1804603682&4294967295,_=T+(A<<7&4294967295|A>>>25),A=x+(b^_&(T^b))+R[13]+4254626195&4294967295,x=_+(A<<12&4294967295|A>>>20),A=b+(T^x&(_^T))+R[14]+2792965006&4294967295,b=x+(A<<17&4294967295|A>>>15),A=T+(_^b&(x^_))+R[15]+1236535329&4294967295,T=b+(A<<22&4294967295|A>>>10),A=_+(b^x&(T^b))+R[1]+4129170786&4294967295,_=T+(A<<5&4294967295|A>>>27),A=x+(T^b&(_^T))+R[6]+3225465664&4294967295,x=_+(A<<9&4294967295|A>>>23),A=b+(_^T&(x^_))+R[11]+643717713&4294967295,b=x+(A<<14&4294967295|A>>>18),A=T+(x^_&(b^x))+R[0]+3921069994&4294967295,T=b+(A<<20&4294967295|A>>>12),A=_+(b^x&(T^b))+R[5]+3593408605&4294967295,_=T+(A<<5&4294967295|A>>>27),A=x+(T^b&(_^T))+R[10]+38016083&4294967295,x=_+(A<<9&4294967295|A>>>23),A=b+(_^T&(x^_))+R[15]+3634488961&4294967295,b=x+(A<<14&4294967295|A>>>18),A=T+(x^_&(b^x))+R[4]+3889429448&4294967295,T=b+(A<<20&4294967295|A>>>12),A=_+(b^x&(T^b))+R[9]+568446438&4294967295,_=T+(A<<5&4294967295|A>>>27),A=x+(T^b&(_^T))+R[14]+3275163606&4294967295,x=_+(A<<9&4294967295|A>>>23),A=b+(_^T&(x^_))+R[3]+4107603335&4294967295,b=x+(A<<14&4294967295|A>>>18),A=T+(x^_&(b^x))+R[8]+1163531501&4294967295,T=b+(A<<20&4294967295|A>>>12),A=_+(b^x&(T^b))+R[13]+2850285829&4294967295,_=T+(A<<5&4294967295|A>>>27),A=x+(T^b&(_^T))+R[2]+4243563512&4294967295,x=_+(A<<9&4294967295|A>>>23),A=b+(_^T&(x^_))+R[7]+1735328473&4294967295,b=x+(A<<14&4294967295|A>>>18),A=T+(x^_&(b^x))+R[12]+2368359562&4294967295,T=b+(A<<20&4294967295|A>>>12),A=_+(T^b^x)+R[5]+4294588738&4294967295,_=T+(A<<4&4294967295|A>>>28),A=x+(_^T^b)+R[8]+2272392833&4294967295,x=_+(A<<11&4294967295|A>>>21),A=b+(x^_^T)+R[11]+1839030562&4294967295,b=x+(A<<16&4294967295|A>>>16),A=T+(b^x^_)+R[14]+4259657740&4294967295,T=b+(A<<23&4294967295|A>>>9),A=_+(T^b^x)+R[1]+2763975236&4294967295,_=T+(A<<4&4294967295|A>>>28),A=x+(_^T^b)+R[4]+1272893353&4294967295,x=_+(A<<11&4294967295|A>>>21),A=b+(x^_^T)+R[7]+4139469664&4294967295,b=x+(A<<16&4294967295|A>>>16),A=T+(b^x^_)+R[10]+3200236656&4294967295,T=b+(A<<23&4294967295|A>>>9),A=_+(T^b^x)+R[13]+681279174&4294967295,_=T+(A<<4&4294967295|A>>>28),A=x+(_^T^b)+R[0]+3936430074&4294967295,x=_+(A<<11&4294967295|A>>>21),A=b+(x^_^T)+R[3]+3572445317&4294967295,b=x+(A<<16&4294967295|A>>>16),A=T+(b^x^_)+R[6]+76029189&4294967295,T=b+(A<<23&4294967295|A>>>9),A=_+(T^b^x)+R[9]+3654602809&4294967295,_=T+(A<<4&4294967295|A>>>28),A=x+(_^T^b)+R[12]+3873151461&4294967295,x=_+(A<<11&4294967295|A>>>21),A=b+(x^_^T)+R[15]+530742520&4294967295,b=x+(A<<16&4294967295|A>>>16),A=T+(b^x^_)+R[2]+3299628645&4294967295,T=b+(A<<23&4294967295|A>>>9),A=_+(b^(T|~x))+R[0]+4096336452&4294967295,_=T+(A<<6&4294967295|A>>>26),A=x+(T^(_|~b))+R[7]+1126891415&4294967295,x=_+(A<<10&4294967295|A>>>22),A=b+(_^(x|~T))+R[14]+2878612391&4294967295,b=x+(A<<15&4294967295|A>>>17),A=T+(x^(b|~_))+R[5]+4237533241&4294967295,T=b+(A<<21&4294967295|A>>>11),A=_+(b^(T|~x))+R[12]+1700485571&4294967295,_=T+(A<<6&4294967295|A>>>26),A=x+(T^(_|~b))+R[3]+2399980690&4294967295,x=_+(A<<10&4294967295|A>>>22),A=b+(_^(x|~T))+R[10]+4293915773&4294967295,b=x+(A<<15&4294967295|A>>>17),A=T+(x^(b|~_))+R[1]+2240044497&4294967295,T=b+(A<<21&4294967295|A>>>11),A=_+(b^(T|~x))+R[8]+1873313359&4294967295,_=T+(A<<6&4294967295|A>>>26),A=x+(T^(_|~b))+R[15]+4264355552&4294967295,x=_+(A<<10&4294967295|A>>>22),A=b+(_^(x|~T))+R[6]+2734768916&4294967295,b=x+(A<<15&4294967295|A>>>17),A=T+(x^(b|~_))+R[13]+1309151649&4294967295,T=b+(A<<21&4294967295|A>>>11),A=_+(b^(T|~x))+R[4]+4149444226&4294967295,_=T+(A<<6&4294967295|A>>>26),A=x+(T^(_|~b))+R[11]+3174756917&4294967295,x=_+(A<<10&4294967295|A>>>22),A=b+(_^(x|~T))+R[2]+718787259&4294967295,b=x+(A<<15&4294967295|A>>>17),A=T+(x^(b|~_))+R[9]+3951481745&4294967295,E.g[0]=E.g[0]+_&4294967295,E.g[1]=E.g[1]+(b+(A<<21&4294967295|A>>>11))&4294967295,E.g[2]=E.g[2]+b&4294967295,E.g[3]=E.g[3]+x&4294967295}r.prototype.u=function(E,_){_===void 0&&(_=E.length);for(var T=_-this.blockSize,R=this.B,b=this.h,x=0;x<_;){if(b==0)for(;x<=T;)i(this,E,x),x+=this.blockSize;if(typeof E=="string"){for(;x<_;)if(R[b++]=E.charCodeAt(x++),b==this.blockSize){i(this,R),b=0;break}}else for(;x<_;)if(R[b++]=E[x++],b==this.blockSize){i(this,R),b=0;break}}this.h=b,this.o+=_},r.prototype.v=function(){var E=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);E[0]=128;for(var _=1;_<E.length-8;++_)E[_]=0;var T=8*this.o;for(_=E.length-8;_<E.length;++_)E[_]=T&255,T/=256;for(this.u(E),E=Array(16),_=T=0;4>_;++_)for(var R=0;32>R;R+=8)E[T++]=this.g[_]>>>R&255;return E};function s(E,_){var T=a;return Object.prototype.hasOwnProperty.call(T,E)?T[E]:T[E]=_(E)}function o(E,_){this.h=_;for(var T=[],R=!0,b=E.length-1;0<=b;b--){var x=E[b]|0;R&&x==_||(T[b]=x,R=!1)}this.g=T}var a={};function l(E){return-128<=E&&128>E?s(E,function(_){return new o([_|0],0>_?-1:0)}):new o([E|0],0>E?-1:0)}function c(E){if(isNaN(E)||!isFinite(E))return f;if(0>E)return C(c(-E));for(var _=[],T=1,R=0;E>=T;R++)_[R]=E/T|0,T*=4294967296;return new o(_,0)}function h(E,_){if(E.length==0)throw Error("number format error: empty string");if(_=_||10,2>_||36<_)throw Error("radix out of range: "+_);if(E.charAt(0)=="-")return C(h(E.substring(1),_));if(0<=E.indexOf("-"))throw Error('number format error: interior "-" character');for(var T=c(Math.pow(_,8)),R=f,b=0;b<E.length;b+=8){var x=Math.min(8,E.length-b),A=parseInt(E.substring(b,b+x),_);8>x?(x=c(Math.pow(_,x)),R=R.j(x).add(c(A))):(R=R.j(T),R=R.add(c(A)))}return R}var f=l(0),m=l(1),y=l(16777216);t=o.prototype,t.m=function(){if(P(this))return-C(this).m();for(var E=0,_=1,T=0;T<this.g.length;T++){var R=this.i(T);E+=(0<=R?R:4294967296+R)*_,_*=4294967296}return E},t.toString=function(E){if(E=E||10,2>E||36<E)throw Error("radix out of range: "+E);if(S(this))return"0";if(P(this))return"-"+C(this).toString(E);for(var _=c(Math.pow(E,6)),T=this,R="";;){var b=k(T,_).g;T=w(T,b.j(_));var x=((0<T.g.length?T.g[0]:T.h)>>>0).toString(E);if(T=b,S(T))return x+R;for(;6>x.length;)x="0"+x;R=x+R}},t.i=function(E){return 0>E?0:E<this.g.length?this.g[E]:this.h};function S(E){if(E.h!=0)return!1;for(var _=0;_<E.g.length;_++)if(E.g[_]!=0)return!1;return!0}function P(E){return E.h==-1}t.l=function(E){return E=w(this,E),P(E)?-1:S(E)?0:1};function C(E){for(var _=E.g.length,T=[],R=0;R<_;R++)T[R]=~E.g[R];return new o(T,~E.h).add(m)}t.abs=function(){return P(this)?C(this):this},t.add=function(E){for(var _=Math.max(this.g.length,E.g.length),T=[],R=0,b=0;b<=_;b++){var x=R+(this.i(b)&65535)+(E.i(b)&65535),A=(x>>>16)+(this.i(b)>>>16)+(E.i(b)>>>16);R=A>>>16,x&=65535,A&=65535,T[b]=A<<16|x}return new o(T,T[T.length-1]&-2147483648?-1:0)};function w(E,_){return E.add(C(_))}t.j=function(E){if(S(this)||S(E))return f;if(P(this))return P(E)?C(this).j(C(E)):C(C(this).j(E));if(P(E))return C(this.j(C(E)));if(0>this.l(y)&&0>E.l(y))return c(this.m()*E.m());for(var _=this.g.length+E.g.length,T=[],R=0;R<2*_;R++)T[R]=0;for(R=0;R<this.g.length;R++)for(var b=0;b<E.g.length;b++){var x=this.i(R)>>>16,A=this.i(R)&65535,pt=E.i(b)>>>16,kn=E.i(b)&65535;T[2*R+2*b]+=A*kn,v(T,2*R+2*b),T[2*R+2*b+1]+=x*kn,v(T,2*R+2*b+1),T[2*R+2*b+1]+=A*pt,v(T,2*R+2*b+1),T[2*R+2*b+2]+=x*pt,v(T,2*R+2*b+2)}for(R=0;R<_;R++)T[R]=T[2*R+1]<<16|T[2*R];for(R=_;R<2*_;R++)T[R]=0;return new o(T,0)};function v(E,_){for(;(E[_]&65535)!=E[_];)E[_+1]+=E[_]>>>16,E[_]&=65535,_++}function I(E,_){this.g=E,this.h=_}function k(E,_){if(S(_))throw Error("division by zero");if(S(E))return new I(f,f);if(P(E))return _=k(C(E),_),new I(C(_.g),C(_.h));if(P(_))return _=k(E,C(_)),new I(C(_.g),_.h);if(30<E.g.length){if(P(E)||P(_))throw Error("slowDivide_ only works with positive integers.");for(var T=m,R=_;0>=R.l(E);)T=U(T),R=U(R);var b=M(T,1),x=M(R,1);for(R=M(R,2),T=M(T,2);!S(R);){var A=x.add(R);0>=A.l(E)&&(b=b.add(T),x=A),R=M(R,1),T=M(T,1)}return _=w(E,b.j(_)),new I(b,_)}for(b=f;0<=E.l(_);){for(T=Math.max(1,Math.floor(E.m()/_.m())),R=Math.ceil(Math.log(T)/Math.LN2),R=48>=R?1:Math.pow(2,R-48),x=c(T),A=x.j(_);P(A)||0<A.l(E);)T-=R,x=c(T),A=x.j(_);S(x)&&(x=m),b=b.add(x),E=w(E,A)}return new I(b,E)}t.A=function(E){return k(this,E).h},t.and=function(E){for(var _=Math.max(this.g.length,E.g.length),T=[],R=0;R<_;R++)T[R]=this.i(R)&E.i(R);return new o(T,this.h&E.h)},t.or=function(E){for(var _=Math.max(this.g.length,E.g.length),T=[],R=0;R<_;R++)T[R]=this.i(R)|E.i(R);return new o(T,this.h|E.h)},t.xor=function(E){for(var _=Math.max(this.g.length,E.g.length),T=[],R=0;R<_;R++)T[R]=this.i(R)^E.i(R);return new o(T,this.h^E.h)};function U(E){for(var _=E.g.length+1,T=[],R=0;R<_;R++)T[R]=E.i(R)<<1|E.i(R-1)>>>31;return new o(T,E.h)}function M(E,_){var T=_>>5;_%=32;for(var R=E.g.length-T,b=[],x=0;x<R;x++)b[x]=0<_?E.i(x+T)>>>_|E.i(x+T+1)<<32-_:E.i(x+T);return new o(b,E.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,LR=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=h,gs=o}).apply(typeof CE<"u"?CE:typeof self<"u"?self:typeof window<"u"?window:{});var Uc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vi(t){if(t.code!==L.FAILED_PRECONDITION||t.message!==KR)throw t;j("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kt{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=kt.makeFromUrl(e,n)}catch{return new kt(e,"")}if(r.path==="")return r;throw _j(e)}static makeFromUrl(e,n){let r=null;const i="([A-Za-z0-9.\\-_]+)";function s(k){k.path.charAt(k.path.length-1)==="/"&&(k.path_=k.path_.slice(0,-1))}const o="(/(.*))?$",a=new RegExp("^gs://"+i+o,"i"),l={bucket:1,path:3};function c(k){k.path_=decodeURIComponent(k.path)}const h="v[A-Za-z0-9_]+",f=n.replace(/[.]/g,"\\."),m="(/([^?#]*).*)?$",y=new RegExp(`^https?://${f}/${h}/b/${i}/o${m}`,"i"),S={bucket:1,path:3},P=n===fC?"(?:storage.googleapis.com|storage.cloud.google.com)":n,C="([^?#]*)",w=new RegExp(`^https?://${P}/${i}/${C}`,"i"),I=[{regex:a,indices:l,postModify:s},{regex:y,indices:S,postModify:c},{regex:w,indices:{bucket:1,path:2},postModify:c}];for(let k=0;k<I.length;k++){const U=I[k],M=U.regex.exec(e);if(M){const E=M[U.indices.bucket];let _=M[U.indices.path];_||(_=""),r=new kt(E,_),U.postModify(r);break}}if(r==null)throw gj(e);return r}}class Ij{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tj(t,e,n){let r=1,i=null,s=null,o=!1,a=0;function l(){return a===2}let c=!1;function h(...C){c||(c=!0,e.apply(null,C))}function f(C){i=setTimeout(()=>{i=null,t(y,l())},C)}function m(){s&&clearTimeout(s)}function y(C,...w){if(c){m();return}if(C){m(),h.call(null,C,...w);return}if(l()||o){m(),h.call(null,C,...w);return}r<64&&(r*=2);let I;a===1?(a=2,I=0):I=(r+Math.random())*1e3,f(I)}let S=!1;function P(C){S||(S=!0,m(),!c&&(i!==null?(C||(a=2),clearTimeout(i),f(0)):C||(a=1)))}return f(0),s=setTimeout(()=>{o=!0,P(!0)},n),P}function Sj(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,m=`\r
--`+l+"--",y=Jn.getBlob(f,r,m);if(y===null)throw _C();const S={name:c.fullPath},P=Bi(s,t.host,t._protocol),C="POST",w=t.maxUploadRetryTime,v=new $r(P,C,If(t,n),w);return v.urlParams=S,v.headers=o,v.body=y.uploadData(),v.errorHandler=Oa(e),v}class md{constructor(e,n,r,i){this.current=e,this.total=n,this.finalized=!!r,this.metadata=i||null}}function tv(t,e){let n=null;try{n=t.getResponseHeader("X-Goog-Upload-Status")}catch{or(!1)}return or(!!n&&(e||["active"]).indexOf(n)!==-1),n}function iz(t,e,n,r,i){const s=e.bucketOnlyServerUrl(),o=CC(e,r,i),a={name:o.fullPath},l=Bi(s,t.host,t._protocol),c="POST",h={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":`${r.size()}`,"X-Goog-Upload-Header-Content-Type":o.contentType,"Content-Type":"application/json; charset=utf-8"},f=ev(o,n),m=t.maxUploadRetryTime;function y(P){tv(P);let C;try{C=P.getResponseHeader("X-Goog-Upload-URL")}catch{or(!1)}return or(Ef(C)),C}const S=new $r(l,c,y,m);return S.urlParams=a,S.headers=h,S.body=f,S.errorHandler=Oa(e),S}function sz(t,e,n,r){const i={"X-Goog-Upload-Command":"query"};function s(c){const h=tv(c,["active","final"]);let f=null;try{f=c.getResponseHeader("X-Goog-Upload-Size-Received")}catch{or(!1)}f||or(!1);const m=Number(f);return or(!isNaN(m)),new md(m,r.size(),h==="final")}const o="POST",a=t.maxUploadRetryTime,l=new $r(n,o,s,a);return l.headers=i,l.errorHandler=Oa(e),l}const hT=256*1024;function oz(t,e,n,r,i,s,o,a){const l=new md(0,0);if(o?(l.current=o.current,l.total=o.total):(l.current=0,l.total=r.size()),r.size()!==l.total)throw vj();const c=l.total-l.current;let h=c;i>0&&(h=Math.min(h,i));const f=l.current,m=f+h;let y="";h===0?y="finalize":c===h?y="upload, finalize":y="upload";const S={"X-Goog-Upload-Command":y,"X-Goog-Upload-Offset":`${l.current}`},P=r.slice(f,m);if(P===null)throw _C();function C(k,U){const M=tv(k,["active","final"]),E=l.current+h,_=r.size();let T;return M==="final"?T=If(e,s)(k,U):T=null,new md(E,_,M==="final",T)}const w="POST",v=e.maxUploadRetryTime,I=new $r(n,w,C,v);return I.headers=S,I.body=P.uploadData(),I.progressCallback=a||null,I.errorHandler=Oa(t),I}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
